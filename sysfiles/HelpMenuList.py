			...
			for (action, help) in actions:
				...
				if isinstance(help, list):
					...
					if config.skin.primary_skin.value == "Arctic/skin.xml":
						entry.extend((
							(eListboxPythonMultiContent.TYPE_TEXT, 0, 0, 400, 36, 0, 0, help[0]),
							(eListboxPythonMultiContent.TYPE_TEXT, 0, 36, 400, 30, 1, 0, help[1])
						))
					else:
						entry.extend((
					...
					if config.skin.primary_skin.value == "Arctic/skin.xml":
						entry.append( (eListboxPythonMultiContent.TYPE_TEXT, 10, 4, 750, 36, 0, 0, help) )
					else:
						entry.append( (eListboxPythonMultiContent.TYPE_TEXT, 10, 4, 750, 36, 0, 0, help) )
