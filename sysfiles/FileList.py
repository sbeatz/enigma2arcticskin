...
def FileEntryComponent(name, absolute = None, isDir = False):
	...
	if config.skin.primary_skin.value == "Arctic/skin.xml":
		res.append((eListboxPythonMultiContent.TYPE_TEXT, 35, 1, 470, 36, 0, RT_HALIGN_LEFT, name))
	else:
...
def MultiFileSelectEntryComponent(name, absolute = None, isDir = False, selected = False):
	...
	if config.skin.primary_skin.value == "Arctic/skin.xml":
		res.append((eListboxPythonMultiContent.TYPE_TEXT, 55, 1, 470, 36, 0, RT_HALIGN_LEFT, name))
	else:
	...
	if png is not None:
		if config.skin.primary_skin.value == "Arctic/skin.xml":
			res.append((eListboxPythonMultiContent.TYPE_PIXMAP_ALPHATEST, 30, 8, 20, 20, png))
		else:
