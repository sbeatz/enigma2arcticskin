...
config.plugins.ArcticSetup.colorstyle = ConfigSelection(choices = [("0", "Hell"), ("1", "Dunkelgrau"), ("2", "Schwarz")], default = "0")
config.plugins.ArcticSetup.AutoSwitch = ConfigYesNo(default = True)
config.plugins.ArcticSetup.daycolorstyle = ConfigSelection(choices = [("0", "Hell"), ("1", "Dunkelgrau"), ("2", "Schwarz")], default = "0")
config.plugins.ArcticSetup.nightcolorstyle = ConfigSelection(choices = [("0", "Hell"), ("1", "Dunkelgrau"), ("2", "Schwarz")], default = "0")
...
def Plugins(**kwargs):
        list = []
        list.append(PluginDescriptor(where = [PluginDescriptor.WHERE_SESSIONSTART], fnc=Arctic_Init_autostart))
