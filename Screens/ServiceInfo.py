...
def ServiceInfoListEntry(a, b, valueType=TYPE_TEXT, param=4):
	...
	if config.skin.primary_skin.value == "Arctic/skin.xml":
		return [
			...
			(eListboxPythonMultiContent.TYPE_TEXT, 0, 0, 300, 36, 0, RT_HALIGN_LEFT, ""),
			(eListboxPythonMultiContent.TYPE_TEXT, 0, 0, 300, 36, 0, RT_HALIGN_LEFT, a),
			(eListboxPythonMultiContent.TYPE_TEXT, 295, 0, 420, 36, 0, RT_HALIGN_LEFT, b)
		]
	else:
		return [
		#PyObject *type, *px, *py, *pwidth, *pheight, *pfnt, *pstring, *pflags;
		...
		(eListboxPythonMultiContent.TYPE_TEXT, 295, 0, 420, 25, 0, RT_HALIGN_LEFT, b)
		]
